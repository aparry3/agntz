...
const OPENROUTER_ROUTES: readonly ProviderModelEntry[] = [
	...
	},
	{
		...
		notes:
			"Maverick: OpenRouter routes it to a no-tool-use endpoint, so tool caps are off for this route (harness run 2026-05-23).",
	},
	{
		provider: "openrouter",
...
export const MATRIX: readonly ProviderModelEntry[] = [
	...
	},
	{
		...
		notes:
			"Command A+ unifies Command A / Vision / Reasoning / Translate (May 2026).",
	},
	...PRIOR_GENERATION,
	...OPENROUTER_ROUTES,
];
