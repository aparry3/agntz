...
import { createMemrez, SqliteMemoryStore } from "../src/index.js";
...
describe("SqliteMemoryStore", () => {
  ...
  it("persists memory entries across store instances", async () => {
    ...
    const write = await memrez.write(["app/user/u_123"], "Prefers email receipts.", {
      topicsHint: ["prefs"],
  ...
  it("scans ancestor scopes and excludes sibling scopes", async () => {
    ...
    await memrez.write(["app/user/u_123"], "User 123 preference.", { topicsHint: ["prefs"] });
    await memrez.write(["app/user/u_456"], "User 456 preference.", { topicsHint: ["prefs"] });
