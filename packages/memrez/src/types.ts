...
export interface MemoryStore {
  ...
  getByTopic(scopePaths: string[], topic: string, limit?: number): Promise<MemoryEntry[]>;
  getTopicMeta(scope: string, topic: string): Promise<Omit<TopicSummary, "count"> | null>;
  setTopicMeta(scope: string, topic: string, meta: { blurb?: string; lastUpdatedAt?: string }): Promise<void>;
  listScopeSlice(scopePaths: string[], opts?: { topics?: string[]; includeSuperseded?: boolean }): Promise<MemoryEntry[]>;
}
