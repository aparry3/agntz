  ...
  return {
    ...
    tools() {
      return [
        ...
        {
          name: "write",
          description: "Write a durable memory fact. The memory resource chooses and validates the namespace.",
          mode: "read-write" as const,
          input: WriteInput,
          async execute(input: z.infer<typeof WriteInput>, ctx: ResourceToolContext) {
            const config = ctx.config as MemoryResourceConfig;
