...
export const ExternalIcon = (p: IconProps) => (
  <svg width="11" height="11" viewBox="0 0 12 12" fill="none" {...p}>
    <path d="M4 2 H10 V8 M10 2 L4 8 M2 4 V10 H8" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
...
export const CheckIcon = (p: IconProps) => (
  <svg width="12" height="12" viewBox="0 0 12 12" fill="none" {...p}>
    <path d="M2 6.5 L5 9.5 L10 3" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);

export const SparkIcon = (p: IconProps) => (
  <svg width="14" height="14" viewBox="0 0 14 14" fill="none" {...p}>
    <path d="M7 1 L8.5 5.5 L13 7 L8.5 8.5 L7 13 L5.5 8.5 L1 7 L5.5 5.5 Z" stroke="currentColor" strokeWidth="1.3" strokeLinejoin="round" />
  </svg>
);

export const CodeIcon = (p: IconProps) => (
  <svg width="14" height="14" viewBox="0 0 14 14" fill="none" {...p}>
    <path d="M5 4 L2 7 L5 10 M9 4 L12 7 L9 10" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);

export const PinIcon = (p: IconProps) => (
  <svg width="12" height="12" viewBox="0 0 14 14" fill="none" {...p}>
    <path d="M7 1 L10 4 L8.5 5.5 L11 8 L8 8 L7 13 L6 8 L3 8 L5.5 5.5 L4 4 Z" stroke="currentColor" strokeWidth="1.3" strokeLinejoin="round" fill="currentColor" fillOpacity="0.12" />
  </svg>
);

export const EyeIcon = (p: IconProps) => (
  <svg width="14" height="14" viewBox="0 0 14 14" fill="none" {...p}>
    <path d="M1.5 7 C3 4 5 3 7 3 C9 3 11 4 12.5 7 C11 10 9 11 7 11 C5 11 3 10 1.5 7 Z" stroke="currentColor" strokeWidth="1.3" />
...
export const BranchIcon = (p: IconProps) => (
  <svg width="14" height="14" viewBox="0 0 14 14" fill="none" {...p}>
    ...
    <path d="M3.5 4.5 V 9.5 M3.5 6 C 3.5 5 5 4.5 10.5 4.5" stroke="currentColor" strokeWidth="1.3" />
  </svg>
);

export const CubeIcon = (p: IconProps) => (
  <svg width="14" height="14" viewBox="0 0 14 14" fill="none" {...p}>
    <path d="M7 1 L12 3.5 L12 9.5 L7 12 L2 9.5 L2 3.5 Z M2 3.5 L7 6 L12 3.5 M7 6 V12" stroke="currentColor" strokeWidth="1.3" strokeLinejoin="round" />
  </svg>
);

export const ServerIcon = (p: IconProps) => (
  <svg width="14" height="14" viewBox="0 0 14 14" fill="none" {...p}>
    <rect x="1.5" y="2" width="11" height="4" rx="0.5" stroke="currentColor" strokeWidth="1.3" />
    <rect x="1.5" y="8" width="11" height="4" rx="0.5" stroke="currentColor" strokeWidth="1.3" />
