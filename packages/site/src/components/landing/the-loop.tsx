	...
	return (
		<Section id="loop" kicker="The loop">
			...
			>
				...
				<Lede>
					Your agent definition is a file. Change it, version it, deploy it like
					any other config. No framework migration. No glue code between
					iterations.
				</Lede>
			</div>
			...
			>
				...
				>
					...
					They live in git, review in PRs, and deploy with your stack — or skip
					the file and build them in the hosted UI.
				</span>
				<a
					href="#hosted"
					style={{
