  ...
  return (
    <Section id="run-it-your-way" kicker="Run it your way">
      ...
      >
        ...
        <Lede>
          The runner is production-grade on day one. Pick where it lives based on how your team
          works — your YAML is the same in all three.
        </Lede>
      </div>
        ...
        {OPTIONS.map((o) => (
          ...
          >
            ...
            <Stack gap={6}>
              ...
              <p style={{ margin: 0, fontSize: 14, color: TOKENS.text2, lineHeight: 1.5 }}>
                {o.tagline}
              </p>
            </Stack>
            ...
            <Stack gap={10} style={{ flex: 1 }}>
              {o.bullets.map((b) => (
                <Row
                  key={b}
                  gap={10}
                  style={{ alignItems: "flex-start", fontSize: 13.5, lineHeight: 1.5 }}
                >
                  <span style={{ color: a.fg, display: "inline-flex", marginTop: 3 }}>
                    <CheckIcon />
                  </span>
                  <span>{b}</span>
                </Row>
            ...
            <Stack gap={8} style={{ paddingTop: 14, borderTop: `1px solid ${TOKENS.line}` }}>
              ...
              <span style={{ fontSize: 13, color: TOKENS.text2, lineHeight: 1.45 }}>{o.best}</span>
              <a
                href="#"
                style={{
                  marginTop: 4,
