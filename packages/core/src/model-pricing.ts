...
const DEFAULT_RATES: Record<string, ModelRate> = {
	...
	"openai/gpt-5": { promptPer1M: 5.0, completionPer1M: 15.0 },
	"openai/gpt-5-mini": { promptPer1M: 0.5, completionPer1M: 2.0 },
	"google/gemini-3-pro": { promptPer1M: 3.0, completionPer1M: 15.0 },
};
