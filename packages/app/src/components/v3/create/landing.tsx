			...
			>
				...
				>
					...
					<div>
						...
						>
							Describe what the agent should do and we&apos;ll draft a manifest,
							or start from a blank canvas and build it block by block.
						</div>
					</div>
