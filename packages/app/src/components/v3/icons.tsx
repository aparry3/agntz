...
export const Sessions = (p: IconProps) => <Icon {...p} d="M3 4h10M3 8h10M3 12h6" />;
...
export const Logs = (p: IconProps) => <Icon {...p} d="M3 4h10M3 7h10M3 10h7M3 13h4" />;
...
export const Dot = ({ size = 8, color = "currentColor" }: { size?: number; color?: string }) => (
...
export const Filter = (p: IconProps) => <Icon {...p} d="M2 3h12l-4.5 5.5V13L6.5 11V8.5L2 3z" />;
...
export const Code = (p: IconProps) => <Icon {...p} d="M5 4L2 8l3 4M11 4l3 4-3 4M9 3l-2 10" />;
