    ...
    <div style={style}>
      {label && (
        <Mono
          size={10}
          color={ag.muted}
          style={{ textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: 5, display: "block" }}
        >
          {label}
        </Mono>
      )}
      <div data-color-mode="light" style={{ border: `1px solid ${ag.line}`, borderRadius: 4, overflow: "hidden", background: ag.surface2 }}>
        <MDEditor
          value={value}
