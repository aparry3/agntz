			...
			<div className="mb-6 flex items-start justify-between gap-4">
				<div>
					...
					<p className="mt-1 text-sm text-zinc-600">
						Agents bundled with the worker (YAML in source). They power
						application features like{" "}
						<span className="font-mono">system:agent-builder</span> for
						&ldquo;Create from description&rdquo;. Read-only — edit the YAML and
