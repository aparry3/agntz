      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", gap: 24 }}>
          <div>
            ...
            <div style={{ marginTop: 5, fontSize: 13, color: ag.text2, maxWidth: 560 }}>
              Reusable instruction + tool bundles. Agents declare which skills they may load; the LLM
              opts into one mid-run via{" "}
          ...
          <div style={{ display: "flex", gap: 8 }}>
            <Btn variant="secondary" icon={<I.Filter size={12} style={{ marginRight: 6 }} />}>
              Filter
            </Btn>
            <Link
              href="/skills/new"
...
function SkillRowItem({
  ...
  return (
    ...
    >
      ...
      <Mono size={12} color={ag.muted} style={{ textAlign: "right", display: "block" }}>
        —
      </Mono>
      <Mono size={11} color={ag.muted}>
        —
...
function EmptyState() {
  return (
    <div style={{ flex: 1, padding: "32px", display: "grid", placeItems: "center" }}>
      <div
        style={{
          width: "100%",
          maxWidth: 560,
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 6 }}>
            {TEMPLATES.map(([n, d]) => (
              ...
              >
                ...
                <div style={{ fontSize: 11.5, color: ag.muted, marginTop: 1 }}>{d}</div>
              </Link>
            ))}
          </div>
        </div>
